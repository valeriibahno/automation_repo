...
public abstract class BaseTest {
    ...
    public void openBasePage() {
        ...
        Assert.assertTrue(headerPage.isDisplayedLogo(), "Logo is displayed");
    }
    ...
    public void screenShotForFailureAndQuit(ITestResult result) {
        if (ITestResult.FAILURE == result.getStatus()) {
            try {
                ...
                FileUtils.copyFile(src, new File("src\\test\\java\\hometask_24_rozetka\\failed_tests\\" + result.getName() + ".jpg"));
            } catch (Exception e) {
